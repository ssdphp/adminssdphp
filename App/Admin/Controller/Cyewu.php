...
class Cyewu extends Common {
    ...
    public function c_index_list(){
        ...
        $list = $Yewu->getList(array(),$_GET['page'],$_GET['pagesize'],array("*"),"sort desc");
    ...
    public function c_product_list(){
        ...
        $yewu_list = $Yewu->getList(array(),$_GET['page'],$_GET['pagesize'],array("*"),"sort desc")->items;
    ...
    public function c_price_edit(){
        ...
        $pinfo = $Yewu_Product->findOne(['id'=>$info['id']]);
        $this->assign(array(
            'info'=>$info,
            'pinfo'=>$pinfo,
            '_GET'=>$_GET,
